    ...
    where TStartupModule : IAbpModule
{
    ...
    [Fact]
    public async Task Should_Not_Create_A_Customer_With_Repeating_Email()
    {
        var exception = await Assert.ThrowsAsync<AbpValidationException>(async () =>
        {
            await _customerAppService.CreateAsync(
    ...
    [Fact]
    public async Task Should_Not_Create_A_Customer_Without_Number()
    {
        var exception = await Assert.ThrowsAsync<AbpValidationException>(async () =>
        {
            await _customerAppService.CreateAsync(
    ...
    [Fact]
    public async Task Should_Not_Create_A_Customer_Without_Ticket()
    {
        var exception = await Assert.ThrowsAsync<AbpValidationException>(async () =>
        {
            await _customerAppService.CreateAsync(
